...
# Plot with "Before" and "After" as separate categories for the graph, but grouped for the legend
Yugo_hc_plot <- ggplot(Yugo_hc_emissions, aes(x = day, y = avg_emission, colour = device_status, group = dev)) +
